...
DataSetup(directory, data, 
          poly.size, poly.percent, strip.projects, projects, select.taxa, taxa,
          set.benefit, new.benefit, set.success, new.success, overlap.indicator, 
          output.monitoring, run.prioritisation, set_budget, summary, output.dir,
          prefix_text, multiplier, weighting, discount.rate, 
          T, stop.iteration, select.projects, project.list)
